...
//import libraries
import { Fade, Bounce, Slide, Flip} from "react-reveal";
        ...
        <div className="wrap">
            ...
            <div className="about-whole">
                <div className="about-top">
                    ...
                    <Fade duration={750}top>
                        <h2>Carl Sachs,<br></br>Web Developer</h2>
                    </Fade>
                    </div>
                    <div className="status">
                        <Flip duration={1500} top>
                ...
                <div className="social-about">
                    <div className="list-soc">
                            <div className="linkedin">
                                ...
                                <div className="link-icon" style={{cursor: "pointer"}} onClick={()=> window.open("https://www.linkedin.com/in/carl-sachs/", "_blank")}>
                            ...
                            <div className="twoicon">
                                <div className="twitter">
                                    ...
                                    <div className="twit-icon" onClick={()=> window.open("https://www.twitter.com/CarltonSachs", "_blank")}>
                                        <svg fill="#0050b3" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitter icon</title><path d="M23.954 4.569c-.885.389-1.83.654-2.825.775 1.014-.611 1.794-1.574 2.163-2.723-.951.555-2.005.959-3.127 1.184-.896-.959-2.173-1.559-3.591-1.559-2.717 0-4.92 2.203-4.92 4.917 0 .39.045.765.127 1.124C7.691 8.094 4.066 6.13 1.64 3.161c-.427.722-.666 1.561-.666 2.475 0 1.71.87 3.213 2.188 4.096-.807-.026-1.566-.248-2.228-.616v.061c0 2.385 1.693 4.374 3.946 4.827-.413.111-.849.171-1.296.171-.314 0-.615-.03-.916-.086.631 1.953 2.445 3.377 4.604 3.417-1.68 1.319-3.809 2.105-6.102 2.105-.39 0-.779-.023-1.17-.067 2.189 1.394 4.768 2.209 7.557 2.209 9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63.961-.689 1.8-1.56 2.46-2.548l-.047-.02z"/></svg>
                                    </div>
                                </div>
                                <div className="gmail">
                                    ...
                                    <div className="gmail-icon" onClick={()=> window.open("https://mail.google.com/mail/?view=cm&fs=1&to=sachscarl@gmail.com&su=Inquiry&body=Thank you for taking the time to send me a message.  I will get back to you promptly!", "_blank")}>
                                        <svg fill="#0050b3" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Gmail icon</title><path d="M24 4.5v15c0 .85-.65 1.5-1.5 1.5H21V7.387l-9 6.463-9-6.463V21H1.5C.649 21 0 20.35 0 19.5v-15c0-.425.162-.8.431-1.068C.7 3.16 1.076 3 1.5 3H2l10 7.25L22 3h.5c.425 0 .8.162 1.069.432.27.268.431.643.431 1.068z"/></svg>
                                    </div>
                                </div>
                            </div>
                        </div>
